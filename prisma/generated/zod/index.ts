...
export const UserScalarFieldEnumSchema = z.enum(['id','name','email','password','created_at','updated_at','phoneNumber']);

export const AuthTokenScalarFieldEnumSchema = z.enum(['id','token','createdAt','expiresAt','userId']);

export const ProductScalarFieldEnumSchema = z.enum(['id','name','price','type','data','imageUrl','likes','isReserved']);
